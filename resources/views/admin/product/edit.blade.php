              ...
              <div class="card mb-6">
                ...
                <div class="card-body">
                    <div class="form-group"> 
                      ...
                      @error('name') is-invalid @enderror" id="" aria-describedby=""
                    ...
                    <div class="form-group">
                      <div class="custom-file">
                        ...
                        @error('image') is-invalid @enderror" id="customFile" name="image">
                    ...
                    <div class="form-group"> 
                        ...
                        @error('price') is-invalid @enderror" id="" aria-describedby=""
                    value="{{$product->price}}">
                          @error('name')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="additional_info" id="summernote1" class="form-control 
                        @error('additional_info') is-invalid @enderror">{!!$product->additional_info!!}</textarea>
